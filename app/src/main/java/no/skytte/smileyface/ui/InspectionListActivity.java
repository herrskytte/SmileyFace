 ...
 * lead to a {@link InspectionDetailActivity} representing
...
public class InspectionListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.inspection_list);
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.inspection_list_content, parent, false);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(InspectionDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        InspectionDetailFragment fragment = new InspectionDetailFragment();
                        fragment.setArguments(arguments);
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.inspection_detail_container, fragment)
                                .commit();
                    } else {
                        Context context = v.getContext();
                        Intent intent = new Intent(context, InspectionDetailActivity.class);
                        intent.putExtra(InspectionDetailFragment.ARG_ITEM_ID, holder.mItem.id);
